...
Protected Class VCalculatorClass
	...
	#tag Method, Flags = &h0
		Sub dvdτcAtTime(τ As Double)
		  dvdτc = ((5/256)^0.125)*(-0.875*((5/256)^0.875)*(91495*η^2*π/ 1512 + 358675*η*π/6048 + 4415*π/4032 - χ1ℓ*(2903*η^3/32 - 257023*η^2/1008 + 1195759*η/18144 + (δ + 1)^2*(100019*η^2/3456 - 796069*η/8064 + 130325/3024)) - χ2ℓ*(2903*η^3/32 - 257023*η^2/1008 + 1195759*η/18144 + (1 - δ)^2*(100019*η^2/3456 - 796069*η/8064 + 130325/3024)) - (743/336 - 11*η/4)^2*(12*π - 3*χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - 3*χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)) + (743/336 - 11*η/4)*(-189*η*π/4 - 4159*π/336 - 2*χ1ℓ*(-281*η^2/8 + 809*η/84 + (31319/4032 - 1159*η/96)*(δ + 1)^2) - 2*χ2ℓ*(-281*η^2/8 + 809*η/84 + (1 - δ)^2*(31319/4032 - 1159*η/96))) + (4*π - χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48))*(59*η^2/9 + 13661*η/1008 - 247*χ1*χ2/24 + 721*χ1ℓ*χ2ℓ/24 + 2*(1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384) - 2*(δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348) + 34103/9072))*(1/(-τ + τc))^0.875/(-τ + τc) - 0.75*((5/256)^0.75)*(856*γE/105 + 56669509*η^3/435456 - 451*η^2*π^2/96 - 541*η^2/1792 - 8*π^2/3 + π*χ1ℓ*(151*η/6 + 75*(δ + 1)^2/8)/2 + π*χ2ℓ*(151*η/6 + 75*(1 - δ)^2/8)/2 - 67*(743/336 - 11*η/4)^3/144 + (743/336 - 11*η/4)*(1357*η^2/432 + 314203*η/48384 - 5681*χ1*χ2/1152 + 16583*χ1ℓ*χ2ℓ/1152 + 23*(1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384)/24 - 23*(δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348)/24 + 784369/435456) + 12*(4*π - χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48))^2/25 - 15308362903/279417600 + 428*log(16)/105)*(1/(-τ + τc))^0.75/(-τ + τc) - 6.11428571428571*((5/256)^0.75)*(1/(-τ + τc))^0.75*log(((5/256)^0.125)*(1/(-τ + τc))^0.125)/(-τ + τc) - 1.01904761904762*((5/256)^0.75)*(1/(-τ + τc))^0.75/(-τ + τc) - 0.625*((5/256)^0.625)*(63*η*π/8 + 4159*π/2016 + χ1ℓ*(-281*η^2/8 + 809*η/84 + (31319/4032 - 1159*η/96)*(δ + 1)^2)/3 + χ2ℓ*(-281*η^2/8 + 809*η/84 + (1 - δ)^2*(31319/4032 - 1159*η/96))/3 + (743/336 - 11*η/4)*(12*π/5 - 3*χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48)/5 - 3*χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)/5))*(1/(-τ + τc))^0.625/(-τ + τc) - 0.5*((5/256)^0.5)*(-59*η^2/72 - 13661*η/8064 + 247*χ1*χ2/192 - 721*χ1ℓ*χ2ℓ/192 - (1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384)/4 + 5*(743/336 - 11*η/4)^2/24 + (δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348)/4 - 34103/72576)*(1/(-τ + τc))^0.5/(-τ + τc) - 0.375*((5/256)^0.375)*(-4*π/5 + χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48)/5 + χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)/5)*(1/(-τ + τc))^0.375/(-τ + τc) - 0.25*((5/256)^0.25)*(743/2016 - 11*η/24)*(1/(-τ + τc))^0.25/(-τ + τc))*(1/(-τ + τc))^0.125 - 0.125*((5/256)^0.125)*(((5/256)^0.875)*(91495*η^2*π/1512 + 358675*η*π/6048 + 4415*π/4032 - χ1ℓ*(2903*η^3/32 - 257023*η^2/1008 + 1195759*η/18144 + (δ + 1)^2*(100019*η^2/3456 - 796069*η/8064 + 130325/3024)) - χ2ℓ*(2903*η^3/32 - 257023*η^2/1008 + 1195759*η/18144 + (1 - δ)^2*(100019*η^2/3456 - 796069*η/8064 + 130325/3024)) - (743/336 - 11*η/4)^2*(12*π - 3*χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - 3*χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)) + (743/336 - 11*η/4)*(-189*η*π/4 - 4159*π/336 - 2*χ1ℓ*(-281*η^2/8 + 809*η/84 + (31319/4032 - 1159*η/96)*(δ + 1)^2) - 2*χ2ℓ*(-281*η^2/8 + 809*η/84 + (1 - δ)^2*(31319/4032 - 1159*η/96))) + (4*π - χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48))*(59*η^2/9 + 13661*η/1008 - 247*χ1*χ2/24 + 721*χ1ℓ*χ2ℓ/24 + 2*(1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384) - 2*(δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348) + 34103/9072))*(1/(-τ + τc))^0.875 + ((5/256)^0.75)*(856*γE/105 + 56669509*η^3/435456 - 451*η^2*π^2/96 - 541*η^2/1792 - 8*π^2/3 + π*χ1ℓ*(151*η/6 + 75*(δ + 1)^2/8)/2 + π*χ2ℓ*(151*η/6 + 75*(1 - δ)^2/8)/2 - 67*(743/336 - 11*η/4)^3/144 + (743/336 - 11*η/4)*(1357*η^2/432 + 314203*η/48384 - 5681*χ1*χ2/1152 + 16583*χ1ℓ*χ2ℓ/1152 + 23*(1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384)/24 - 23*(δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348)/24 + 784369/435456) + 12*(4*π - χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48) - χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48))^2/25 - 15308362903/279417600 + 428*log(16)/105)*(1/(-τ + τc))^0.75 + 856*((5/256)^0.75)*(1/(-τ + τc))^0.75*log(((5/256)^0.125)*(1/(-τ + τc))^0.125)/105 + ((5/256)^0.625)*(63*η*π/8 + 4159*π/2016 + χ1ℓ*(-281*η^2/8 + 809*η/84 + (31319/4032 - 1159*η/96)*(δ + 1)^2)/3 + χ2ℓ*(-281*η^2/8 + 809*η/84 + (1 - δ)^2*(31319/4032 - 1159*η/96))/3 + (743/336 - 11*η/4)*(12*π/5 - 3*χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48)/5 - 3*χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)/5))*(1/(-τ + τc))^0.625 + ((5/256)^0.5)*(-59*η^2/72 - 13661*η/8064 + 247*χ1*χ2/192 - 721*χ1ℓ*χ2ℓ/192 - (1 - δ)^2*(233*χ2^2/384 - 719*χ2ℓ^2/384)/4 + 5*(743/336 - 11*η/4)^2/24 + (δ + 1)^2*(233*χ1^2/384 - 719*χ1ℓ^2/348)/4 - 34103/72576)*(1/(-τ + τc))^0.5 + ((5/256)^0.375)*(-4*π/5 + χ1ℓ*(25*η/4 + 113*(δ + 1)^2/48)/5 + χ2ℓ*(25*η/4 + 113*(1 - δ)^2/48)/5)*(1/(-τ + τc))^0.375 + ((5/256)^0.25)*(743/2016 - 11*η/24)*(1/(-τ + τc))^0.25 + 1)*(1/(-τ + τc))^0.125/(-τ + τc) τc)
