...
Protected Class WaveBuilderClass
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdβ()
		  ...
		  dAdβ(21) = 96*c1p7*η*s1*sβ2*cβ2 - 32*c1p7*η*s1*cβ^4 - 32*c1p7*s1*sβ2*cβ2 + 32/3 *c1p7*s1*cβ^4
		  ...
		  dAdβ(32) = - 96*η*sβ2*cβ2*c1*s1p7 + 32*η*s1p7*cβ^4*c1 + 32*sβ2*cβ2*c1*s1p7 - 32/3 *cβ^4*c1*s1p7
		  ...
		  dAdβ(36) = 31/2 *η*c2β*c1p3*c2*s1 - 31/6 *c2β*c1p3*c2*s1 - 1/2 *η*c2β*c1p3*c4*s1 + 1/6 *c2β*c1p3*c4*s1 - 32/3 *η*c2β*c1p3*s1 + 19/4 *η*c4β*c1p3*s1 - 7/2 *η*c4β*c1p3*s3^2 + 7/4 *η*c4β*c1p3*s5 + 12*c2β*c1p3*s1 - 19/12 *c4β*c1p3*s1 + 7/6 *c4β*c1p3*s3 - 7/12 *c4β*c1p3*s5 //error found
		  ...
		  dAdβ(43) = 1/2 *δ*sβ*c2*χsxDN - 1/2 *sβ*χsxDN*δ - δ*cβ*s1p2*χszDN
		  ...
		  dAdβ(76) = - 3125/192*δ*η*cβ*sβ*c3β*c1*s1p9 + 3125/384 *δ*cβ*sβ*c3β*c1*s1p9 + 11875/384 *δ*η*sβ3*c1*s1p9 - 11875/192* δ*η*cβ*sβ*c1*s1p9*cβ2 - 11875/768*δ*sβ3*c1*s1p9 + 11875/384*δ*cβ*sβ*c1*s1p9*cβ2
		  dAdβ(77) = 625/192*δ*η*sβ3 *s2β*s1p10 - 625/128* δ*η*sβ2 *cβ*c2β*s1p10 - 1875/128*δ*η*sβ2*cβ*s1p10 - 625/384*δ*sβ3*s2β*s1p10 + 625/256*δ*sβ2 *cβ*c2β*s1p10 + 1875/256*δ*sβ2 *cβ*s1p10
		  ...
		  dAdβ(85) = η*sβ2*c2p3*χsxDN - η*cβ2*c2p3*χsxDN - 2*sβ2*c2p3*χsxDN + 2*cβ2*c2p3*χsxDN
		  ...
		  dAdβ(89) = - 7/6 *η*s2β*c1p3*c2*s1*χsxDN - 35/3 *s2β*c1p3*c2*s1*χsxDN + 4/3 *η*c2β*c1p3*c2*s1*χszDN + 40/3 *c2β*c1p3*c2*s1*χszDN - 79/6 *η*s2β*c1p3*s1*χsxDN + 13/3 *s2β*c1p3*s1*χsxDN - 14*η*c2β*c1p3*s1*χszDN - 4*c2β*c1p3*s1*χszDN
		  ...
		  dAdβ(111) = - 35/3 *δ*s2β*c1p3*c2*s1*χaxDN + 40/3 *δ*c2β*c1p3*c2*s1*χazDN + 13/3 *δ*s2β*c1p3*s1*χaxDN - 4*δ*c2β*c1p3*s1*χazDN
		  ...
		  dAdβ(163) = 0
		  dAdβ(164) = 0
		  dAdβ(165) = sβ *cβ *c2*χaxDN - 1/2 *sβ2 *c2*χazDN + 1/2 *cβ2 *c2*χazDN - sβ *cβ *χaxDN + 1/2 *sβ2 *χazDN - 1/2 *cβ2 *χazDN
		  dAdβ(166) = -sβ2 *s2*χaxDN + cβ2 *s2*χaxDN - 2*sβ *cβ *s2*χazDN
		  dAdβ(167) = -sβ *cβ *c2*χaxDN + 1/2 *sβ2 *c2*χazDN - 1/2 *cβ2 *c2*χazDN - sβ* cβ *χaxDN + 1/2 *sβ2 *χazDN - 1/2 *cβ2 *χazDN
		  dAdβ(168) = 0
		  dAdβ(169) = 0
		  dAdβ(170) = δ*sβ *cβ *c2*χsxDN - 1/2 *δ*sβ2 *c2*χszDN + 1/2 *δ*cβ2 *c2*χszDN - δ*sβ *cβ *χsxDN + 1/2* δ*sβ2 *χszDN - 1/2* δ*cβ2 *χszDN
		  dAdβ(171) = -δ*sβ2 *s2*χsxDN + δ*cβ2 *s2*χsxDN - 2*δ*sβ *cβ *s2*χszDN
		  dAdβ(172) = -δ*sβ *cβ *c2*χsxDN + 1/2* δ*sβ2 *c2*χszDN - 1/2* δ*cβ2 *c2*χszDN - δ*sβ *cβ *χsxDN + 1/2 *δ*sβ2 *χszDN - 1/2 *δ*cβ2 *χszDN
		  ...
		  dAdβ(181) = 625/96 *δ*η*sβ^4* s1p10 - 625/32 *δ*η*sβ2* cβ2 *s1p10 - 625/192* δ*sβ^4 *s1p10 + 625/64* δ*sβ2 *cβ2 *s1p10
		  ...
		  dAdβ(186) = 81/32 *δ*η*sβ^4 *s1p8*c1p2 - 243/32 *δ*η*sβ2 *cβ2 *s1p8*c1p2 - 81/64* δ*sβ^4 *s1p8*c1p2 + 243/64 *δ*sβ2 *cβ2 *s1p8*c1p2
		  ...
		  dAdβ(191) = 1/48 *δ*η*sβ^4 *c1p4*s1p6 - 1/16 *δ*η*sβ2 *cβ2* c1p4*s1p6 - 1/96 *δ*sβ^4 *c1p4*s1p6 + 1/32 *δ*sβ2 *cβ2 *c1p4*s1p6
		  ...
		  dAdβ(200) = - 81/32 *δ*η*sβ^4 *s1p2*c1p8 + 243/32 *δ*η*sβ2 *cβ2 *s1p2*c1p8 + 81/64* δ*sβ^4 *s1p2*c1p8 - 243/64* δ*sβ2 *cβ2 *s1p2*c1p8
		  ...
		  dAdβ(205) = - 625/96* δ*η*sβ^4 *c1p10 + 625/32* δ*η*sβ2 *cβ2 *c1p10 + 625/192* δ*sβ^4 *c1p10 - 625/64* δ*sβ2 *cβ2 *c1p10
		  dAdβ(206) = -η*cβ *c2p3*χsyDN + 2*cβ *c2p3*χsyDN
		  dAdβ(207) = 2/3 *η*cβ *c2*c1p4*χsyDN + 20/3 *cβ *c2*c1p4*χsyDN - 5/3 *η*cβ *c1p4*χsyDN - 14/3 *cβ *c1p4*χsyDN
		  dAdβ(208) = 2/3 *η*sβ *s1*c1p5*χsyDN + 20/3 *sβ *s1*c1p5*χsyDN
		  dAdβ(209) = - 1/3 *η*sβ *s1*c2*c1p3*χsyDN - 10/3 *sβ *s1*c2*c1p3*χsyDN - 7/3 *η*sβ *s1*c1p3*χsyDN + 2/3* sβ *s1*c1p3*χsyDN
		  dAdβ(210) = 1/3 *η*sβ *s1p3*c2*c1*χsyDN + 10/3 *sβ *s1p3*c2*c1*χsyDN - 7/3 *η*sβ *s1p3*c1*χsyDN + 2/3 *sβ *s1p3*c1*χsyDN
		  dAdβ(211) = 2/3 *η*cβ *s1p4*c2*χsyDN + 20/3 *cβ *s1p4*c2*χsyDN + 5/3 *η*cβ *s1p4*χsyDN + 14/3 *cβ *s1p4*χsyDN
		  dAdβ(212) = 2/3* η*sβ *s1p5*c1*χsyDN + 20/3 *sβ *s1p5*c1*χsyDN
		  dAdβ(213) = -η*cβ *s2p2*c2*χsyDN + 2*cβ *s2p2*c2*χsyDN
		  dAdβ(214) = 1/3 *η*cβ* s2p2*c2*χsyDN + 10/3 *cβ *s2p2*c2*χsyDN
		  dAdβ(215) = - 1/2 *η*sβ *s2p3*χsyDN + sβ *s2p3*χsyDN
		  dAdβ(216) = - 5/8 *η*sβ *s2*χsyDN - 1/8 *η*sβ *s6*χsyDN + 5/4 *sβ* s2*χsyDN + 1/4 *sβ *s6*χsyDN
		  dAdβ(217) = - 1/4 *η*sβ *s2*c4*χsxDN + 1/2 *sβ *s2*c4*χsxDN + η*cβ *s2*c4*χszDN - 2*cβ *s2*c4*χszDN - 3/4 *η*sβ *s2*χsxDN + 3/2 *sβ *s2*χsxDN
		  dAdβ(218) = η*cβ *c2*s2p2*χsxDN - 2*cβ*c2*s2p2*χsxDN + η*sβ* s2p2*c2*χszDN - 2*sβ *c2*s2p2*χszDN
		  dAdβ(219) = 2*η*sβ *s2p3*χsxDN - 4*sβ *s2p3*χsxDN
		  dAdβ(220) = 1/3 *η*sβ* c1*c2*s1p3*χsxDN + 10/3 *sβ *c1*c2*s1p3*χsxDN - 4/3 *η*cβ *c1*c2*s1p3*χszDN - 40/3 *cβ *c1*c2*s1p3*χszDN+ 5/3 *η*sβ *c1*s1p3*χsxDN + 2/3* sβ* c1*s1p3*χsxDN - 2*η*cβ *c1*s1p3*χszDN - 4*cβ* c1*s1p3*χszDN
		  dAdβ(221) = - 2/3 *η*cβ *c2*s1p4*χsxDN - 20/3 *cβ *c2*s1p4*χsxDN - 2/3 *η*sβ *c2*s1p4*χszDN - 20/3 *sβ *c2*s1p4*χszDN+ 10/3* η*cβ *s1p4*χsxDN - 14/3 *cβ *s1p4*χsxDN - 5*η*sβ *s1p4*χszDN - 4*sβ *s1p4*χszDN
		  dAdβ(222) = - 2/3 *η*sβ *s1p5*c1*χsxDN - 20/3 *sβ *s1p5*c1*χsxDN
		  dAdβ(223) = -6*η*sβ *s2β *s2p2*χsxDN + 3*η*cβ *c2β* s2p2*χsxDN - 7/6 *η*cβ* s2p2*χsxDN + 1/3 *cβ *s2p2*χsxDN + 6*η*sβ3* s2p2*χszDN - 12*η*sβ* cβ2* s2p2*χszDN
		  dAdβ(224) = - 1/3* η*sβ *c1p3*c2*s1*χsxDN - 10/3 *sβ *c1p3*c2*s1*χsxDN + 4/3 *η*cβ *c1p3*c2*s1*χszDN + 40/3 *cβ *c1p3*c2*s1*χszDN+ 5/3 *η*sβ *c1p3*s1*χsxDN + 2/3 *sβ *c1p3*s1*χsxDN - 2*η*cβ *c1p3*s1*χszDN - 4*cβ *c1p3*s1*χszDN
		  dAdβ(225) = - 2/3 *η*cβ *c1p4*c2*χsxDN - 20/3 *cβ *c1p4*c2*χsxDN - 2/3 *η*sβ *c1p4*c2*χszDN - 20/3 *sβ *c1p4*c2*χszDN - 10/3 *η*cβ *c1p4*χsxDN+ 14/3 *cβ *c1p4*χsxDN + 5*η*sβ *c1p4*χszDN + 4*sβ *c1p4*χszDN
		  dAdβ(226) = - 2/3 *η*sβ *s1*c1p5*χsxDN - 20/3 *sβ *s1*c1p5*χsxDN
		  dAdβ(227) = 2*δ*cβ *c2p3*χayDN
		  dAdβ(228) = 20/3* δ*cβ *c2*c1p4*χayDN - 14/3 *δ*cβ *c1p4*χayDN
		  dAdβ(229) = - 10/3 *δ*sβ *s1*c2*c1p3*χayDN + 2/3 *δ*sβ *s1*c1p3*χayDN
		  dAdβ(230) = 20/3 *δ*sβ *s1*c1p5*χayDN
		  dAdβ(231) = 10/3 *δ*sβ *s1p3*c2*c1*χayDN + 2/3 *δ*sβ *s1p3*c1*χayDN
		  dAdβ(232) = 20/3 *δ*cβ *s1p4*c2*χayDN + 14/3 *δ*cβ *s1p4*χayDN
		  dAdβ(233) = 20/3 *δ*sβ *c1*s1p5*χayDN
		  dAdβ(234) = 2*δ*cβ *c2*s2p2*χayDN
		  dAdβ(235) = 10/3* δ*cβ* s2p2*c2*χayDN
		  dAdβ(236) = δ*sβ *s1p3*χayDN
		  dAdβ(237) = 5/4 *δ*sβ *s2*χayDN + 1/4 *δ*sβ *s6*χayDN
		  dAdβ(238) = 1/2 *δ*sβ *s2*c4*χaxDN - 2*δ*cβ *s2*c4*χazDN + 3/2 *δ*sβ* s2*χaxDN
		  dAdβ(239) = -2*δ*cβ *c2*s2p2*χaxDN - 2*δ*sβ *c2*s2p2*χazDN
		  dAdβ(240) = -δ*sβ *s2p3*χaxDN
		  dAdβ(241) = 10/3 *δ*sβ *s1p3*c2*c1*χaxDN - 40/3* δ*cβ *s1p3*c2*c1*χazDN + 2/3 *δ*sβ *s1p3*c1*χaxDN - 4*δ*cβ *s1p3*c1*χazDN
		  dAdβ(242) = - 20/3 *δ*cβ *s1p4*c2*χaxDN - 20/3 *δ*sβ *s1p4*c2*χazDN - 14/3 *δ*cβ *s1p4*χaxDN - 4*δ*sβ *s1p4*χazDN
		  dAdβ(243) = - 20/3 *δ*sβ *c1*s1p5*χaxDN
		  dAdβ(244) = 1/3* δ*cβ* s2p2*χaxDN
		  dAdβ(245) = - 10/3* δ*sβ *s1*c2*c1p3*χaxDN + 40/3 *δ*cβ *s1*c2*c1p3*χazDN + 2/3 *δ*sβ *s1*c1p3*χaxDN - 4*δ*cβ *s1*c1p3*χazDN
		  dAdβ(246) = - 20/3 *δ*cβ *c2*c1p4*χaxDN - 20/3 *δ*sβ *c2*c1p4*χazDN + 14/3 *δ*cβ *c1p4*χaxDN + 4*δ*sβ *c1p4*χazDN
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdδ()
		  ...
		  dAdδ(96) = - 11/64* δ*c2β *s2*χsxDN - 3/16 *δ*s2p3*χsxDN - 7/64* δ*c2β *s6*χsxDN + 1/8* δ*s2β *s2*χszDN - 1/8* δ*s2β *s6*χszDN
		  dAdδ(97) = 15/32* δ*s2*χsyDN - 3/32* δ*c2β *s2*χsyDN + 9/32* δ*c4*s2*χsyDN - 5/32* δ*c2β *c4*s2*χsyDN
		  dAdδ(98) = - 1/2* δ*cβ *sβ *c2*s2p2*χsyDN
		  dAdδ(99) = 3/16* δ*s2p3*χsyDN + 1/16 *δ*c2β *s2p3*χsyDN
		  dAdδ(100) = 5/24* δ*c2β *c2*c1*s1p3*χsyDN + 31/24* δ*c2β* c1*s1p3*χsyDN - 3/8* δ*c2*c1*s1p3*χsyDN- 1/8* δ*c1*s1p3*χsyDN
		  dAdδ(101) = 5/12 *δ*s2β* s1p4*χsyDN + 1/6* δ*s2β *c2*s1p4*χsyDN
		  dAdδ(102) = - 1/4 *δ*c1*s1p5*χsyDN - 1/12* δ*c2β *c1*s1p5*χsyDN
		  dAdδ(103) = 11/12* δ*cβ *sβ* s2p2*χsyDN
		  dAdδ(104) = - 1/8 *δ*c1p3*s1*χsyDN + 31/24* δ*c2β* c1p3*s1*χsyDN + 3/8* δ*c1p3*c2*s1*χsyDN - 5/24* δ*c2β* c1p3*c2*s1*χsyDN
		  dAdδ(105) = - 5/12* δ*s2β* c1p4*χsyDN + 1/6 *δ*s2β* c1p4*c2*χsyDN
		  dAdδ(106) = - 1/4 *δ*c1p5*s1*χsyDN - 1/12*δ*c2β* c1p5*s1*χsyDN
		  dAdδ(107) = 2*sβ *cβ* c2p3*χaxDN
		  dAdδ(108) = -3*c1p4*χazDN - c2β *c1p4*χazDN + 5*c1p4*c2*χazDN + 5/3 *c2β* c1p4*c2*χazDN + 7/3 *s2β* c1p4*χaxDN - 10/3 *s2β* c1p4*c2*χaxDN
		  dAdδ(109) = 5*c1p5*s1*χaxDN + 5/3* c2β* c1p5*s1*χaxDN
		  dAdδ(110) = 5*c1*s1p5*χaxDN + 5/3 *c2β *c1*s1p5*χaxDN
		  dAdδ(111) = 35/6 *c2β* c2*c1p3*s1*χaxDN - 13/6 *c2β *c1p3*s1*χaxDN - 5/2 *c2*c1p3*s1*χaxDN + 20/3 *s2β *c2*c1p3*s1*χazDN+ 3/2 *c1p3*s1*χaxDN - 2*s2β *c1p3*s1*χazDN
		  dAdδ(112) = - 35/6 *c2β *c2*c1*s1p3*χaxDN - 13/6 *c2β* c1*s1p3*χaxDN + 5/2* c2*c1*s1p3*χaxDN - 20/3 *s2β *c2*c1*s1p3*χazDN+ 3/2 *c1*s1p3*χaxDN - 2*s2β *c1*s1p3*χazDN
		  dAdδ(113) = 5/3 *c2β* c2*s1p4*χazDN + c2β* s1p4*χazDN - 10/3 *s2β *c2*s1p4*χaxDN + 5*c2*s1p4*χazDN- 7/3 *s2β *s1p4*χaxDN + 3*s1p4*χazDN
		  dAdδ(114) = - 3*sβ2 *c2*s2p2*χazDN
		  dAdδ(115) = 3/4 *s2p3*χaxDN + 1/4 *c2β* s2p3*χaxDN
		  dAdδ(116) = 10/3 *cβ* sβ* c2*s2p2*χaxDN + 5*sβ2* c2*s2p2*χazDN
		  dAdδ(117) = 3/2 *c2*s2p2*χazDN + 1/2 *c2β *c2*s2p2*χazDN - s2β *c2*s2p2*χaxDN
		  dAdδ(118) = - 11/16 *c2β* s2*χaxDN - 7/16 *c2β *s6*χaxDN - 3/4 *s2p3*χaxDN + 1/2 *s2β* s2*χazDN - 1/2 *s2β *s6*χazDN
		  dAdδ(119) = - 5/8 *c2β* c4*s2*χayDN - 3/8 *c2β *s2*χayDN + 9/8 *c4*s2*χayDN + 15/8 *s2*χayDN
		  dAdδ(120) = - 2*cβ *sβ *c2*s2p2*χayDN
		  dAdδ(121) = 3/4 *s2p3*χayDN + 1/4 *c2β* s2p3*χayDN
		  dAdδ(122) = - 25/6 *c2β *c2*c1*s1p3*χayDN - 11/6* c2β *c1*s1p3*χayDN + 15/2 *c2*c1*s1p3*χayDN + 5/2 *c1*s1p3*χayDN
		  dAdδ(123) = - 7/3 *s2β *s1p4*χayDN - 10/3 *s2β *s1p4*c2*χayDN
		  dAdδ(124) = 5*c1*s1p5*χayDN + 5/3 *c2β *c1*s1p5*χayDN
		  dAdδ(125) = - 1/3 *cβ *sβ *s2p2*χayDN
		  dAdδ(126) = 25/6 *c2β *c2*c1p3*s1*χayDN - 11/6* c2β* c1p3*s1*χayDN - 15/2 *c2*c1p3*s1*χayDN + 5/2 *c1p3*s1*χayDN
		  dAdδ(127) = 7/3 *s2β* c1p4*χayDN - 10/3 *s2β* c1p4*c2*χayDN
		  dAdδ(128) = 5*c1p5*s1*χayDN + 5/3* c2β* c1p5*s1*χayDN
		  dAdδ(129) = 0
		  dAdδ(130) = 0
		  dAdδ(131) = 0
		  dAdδ(132) = 0
		  ...
		  dAdδ(166) = 0
		  dAdδ(167) = 0
		  dAdδ(168) = 1/2 *χsyDN + 1/2 *c2*χsyDN
		  dAdδ(169) = s1p2*χsyDN
		  dAdδ(170) = - 1/2 *cβ2* c2*χsxDN + 1/2 *cβ2* χsxDN + 1/2* cβ *sβ *c2*χszDN - 1/2* cβ* sβ *χszDN
		  dAdδ(171) = cβ *sβ* s2*χsxDN - sβ2* s2*χszDN
		  dAdδ(172) = 1/2 *cβ2 *c2*χsxDN + 1/2* cβ2 *χsxDN - 1/2 *cβ *sβ *c2*χszDN - 1/2 *cβ *sβ *χszDN
		  dAdδ(173) = 0
		  dAdδ(174) = 0
		  dAdδ(175) = 0
		  dAdδ(176) = 0
		  ...
		  dAdδ(180) = - 625/96* c2β *sβ2* s1p9*c1 + 1875/96 *δ^2*c2β *sβ2* s1p9*c1 + 625/48 *c2β *sβ2* s1p9*c1 - 625/192 *sβ2* s1p9*c1 _
		  ...
		  dAdδ(197) = - 27/64*c2β*c2*c1p5*s1+ 81/64*δ^2*c2β*c2*c1p5*s1+ 27/32*c2β*c2*c1p5*s1- 81/512*c2β*c4*c1p5*s1+ 243/512*δ^2*c2β*c4*c1p5*s1+ 81/256*c2β*c4*c1p5*s1+ 1233/512*c2β*c1p5*s1- 3699/512*δ^2*c2β*c1p5*s1- 4689/1024*c2β*c1p5*s1- 27/64*c4β*c1p5*c2*s1+ 81/64*δ^2*c4β*c1p5*c2*s1+ 27/32*c4β*c1p5*c2*s1- 27/32*c2*c1p5*s1+ 81/32*δ^2*c2*c1p5*s1+ 27/16*c2*c1p5*s1- 243/512*c4β*c4*c1p5*s1+ 729/512*δ^2*c4β*c4*c1p5*s1+ 243/256*c4β*c4*c1p5*s1+ 27/512*c4β*c1p5*s1- 81/512*δ^2*c4β*c1p5*s1- 27/256*c4β*c1p5*s1+ 27/64* c1p5*s1- 81/64*δ^2* c1p5*s1- 27/32* c1p5*s1
		  ...
		  dAdδ(207) = - 1/3* δ*sβ *c1p4*c2*χsyDN + 5/6* δ*sβ *c1p4*χsyDN
		  dAdδ(208) = 1/3 *δ*cβ *s1*c1p5*χsyDN
		  dAdδ(209) = - 1/6* δ*cβ *s1*c2*c1p3*χsyDN - 7/6* δ*cβ *s1*c1p3*χsyDN
		  dAdδ(210) = 1/6 *δ*cβ *s1p3*c2*c1*χsyDN - 7/6 *δ*cβ *s1p3*c1*χsyDN
		  dAdδ(211) = - 1/3* δ*sβ *c2*s1p4*χsyDN - 5/6 *δ*sβ* s1p4*χsyDN
		  ...
		  dAdδ(216) = - 5/16* δ*cβ *s2*χsyDN - 1/16* δ*cβ *s6*χsyDN
		  dAdδ(217) = - 3/8 *δ*cβ *s2*χsxDN - 1/8* δ*cβ* c4*s2*χsxDN - 1/2* δ*sβ *c4*s2*χszDN
		  dAdδ(218) = 1/2 *δ*cβ* s2p2*c2*χszDN - 1/2* δ*sβ *s2p2*c2*χsxDN
		  dAdδ(219) = δ*cβ *s2p3*χsxDN
		  dAdδ(220) = 1/6* δ*cβ *s1p3*c2*c1*χsxDN + 2/3* δ*sβ *s1p3*c2*c1*χszDN - 2*δ*c3β* s1p3*c1*χsxDN + 5/6* δ*cβ *s1p3*c1*χsxDN + 2*δ*s3β *s1p3*c1*χszDN + δ*sβ* s1p3*c1*χszDN
		  dAdδ(221) = - 1/3* δ*cβ *c2*s1p4*χszDN + 1/3* δ*sβ *s1p4*c2*χsxDN - 1/2* δ*c3β *s1p4*χszDN - 5/2* δ*cβ *s1p4*χszDN - 1/2* δ*s3β* s1p4*χsxDN- 5/3 *δ*sβ* s1p4*χsxDN
		  dAdδ(222) = - 1/3* δ*cβ *c1*s1p5*χsxDN
		  dAdδ(223) = - 3/2* δ*sβ *c2β *s2p2*χsxDN + 3*δ*sβ2 *cβ* s2p2*χszDN + 7/12 *δ*sβ *s2p2*χsxDN
		  dAdδ(224) = - 1/6 *δ*cβ *c2*c1p3*s1*χsxDN - 2/3 *δ*sβ *s1*c2*c1p3*χszDN - 2*δ*c3β *c1p3*s1*χsxDN + 5/6* δ*cβ *c1p3*s1*χsxDN+2*δ*s3β *s1*c1p3*χszDN + δ*sβ *s1*c1p3*χszDN
		  dAdδ(225) = - 1/3 *δ*cβ *c2*c1p4*χszDN + 1/3* δ*sβ *c2*c1p4*χsxDN + 1/2* δ*c3β *c1p4*χszDN + 5/2 *δ*cβ* c1p4*χszDN + 1/2 *δ*s3β* c1p4*χsxDN+ 5/3 *δ*sβ* c1p4*χsxDN
		  dAdδ(226) = - 1/3 *δ*cβ *c1p5*s1*χsxDN
		  dAdδ(227) = 2*sβ *c2p3*χayDN
		  dAdδ(228) = - 14/3 *sβ *c1p4*χayDN + 20/3 *sβ *c2*c1p4*χayDN
		  dAdδ(229) = - 2/3 *cβ *c1p3*s1*χayDN + 10/3 *cβ *c2*c1p3*s1*χayDN
		  dAdδ(230) = - 20/3 *cβ *c1p5*s1*χayDN
		  dAdδ(231) = - 10/3 *cβ *s1p3*c2*c1*χayDN - 2/3 *cβ *s1p3*c1*χayDN
		  dAdδ(232) = 20/3 *sβ* s1p4*c2*χayDN + 14/3 *sβ *s1p4*χayDN
		  dAdδ(233) = - 20/3 *cβ *c1*s1p5*χayDN
		  dAdδ(234) = 2*sβ *c2*s2p2*χayDN
		  dAdδ(235) = 10/3 *sβ *c2*s2p2*χayDN
		  dAdδ(236) = -cβ *s1p3*χayDN
		  dAdδ(237) = - 5/4 *cβ *s2*χayDN - 1/4 *cβ *s6*χayDN
		  dAdδ(238) = - 1/2 *cβ* s2*c4*χaxDN - 2*sβ *s2*c4*χazDN - 3/2* cβ *s2*χaxDN
		  dAdδ(239) = 2*cβ* c2*s2p2*χazDN - 2*sβ *c2*s2p2*χaxDN
		  dAdδ(240) = cβ* s2p3*χaxDN
		  dAdδ(241) = - 10/3 *cβ *c2*c1*s1p3*χaxDN - 40/3 *sβ* s1p3*c2*c1*χazDN - 2/3 *cβ* c1*s1p3*χaxDN - 4*sβ *s1p3*c1*χazDN
		  dAdδ(242) = 20/3 *cβ* s1p4*c2*χazDN - 20/3 *sβ *s1p4*c2*χaxDN + 4*cβ *s1p4*χazDN - 14/3 *sβ *s1p4*χaxDN
		  dAdδ(243) = 20/3 *cβ* c1*s1p5*χaxDN
		  dAdδ(244) = 1/3 *sβ *s2p2*χaxDN
		  dAdδ(245) = 10/3 *cβ *c2*c1p3*s1*χaxDN + 40/3 *sβ *s1*c2*c1p3*χazDN - 2/3 *cβ *s1*c1p3*χaxDN - 4*sβ *s1*c1p3*χazDN
		  dAdδ(246) = 20/3 *cβ *c2*c1p4*χazDN - 20/3 *sβ *c2*c1p4*χaxDN - 4*cβ* c1p4*χazDN + 14/3 *sβ* c1p4*χaxDN
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdχsxDN()
		  ...
		  dAdχsxDN(218) = η*sβ *s2p2*c2 - 2*sβ* s2p2*c2
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdχsyDN()
		  ...
		  dAdχsyDN(104) = 1/4* η*c1p3*s1 - 31/12 *η*c2β* c1p3*s1 - 3/4 *η*c1p3*c2*s1 + 5/12* η*c2β* c1p3*c2*s1 + 5/2* c1p3*s1 - 11/6 *c2β *c1p3*s1 - 15/2* c1p3*c2*s1 + 25/6* c2β* c1p3*c2*s1
