...
Protected Class WaveBuilderClass
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdβ()
		  ...
		  dAdβ(77) = 625 192*δ*η*s3 β s2β*s1p10 - 625/128* δ*η*sβ2 *cβ*c2β*s1p10 - 1875/128*δ*η*sβ2*cβ*s1p10 - 625/384*δ*sβ3*s2β*s1p10 + 625/256*δ*sβ2 *cβ*c2β*s1p10 + 1875/256*δ*sβ2 *cβ*s1p10
	...
	#tag Method, Flags = &h0
		Sub CalculateDAdδ()
		  ...
		  dAdδ(90) =  7/48∗c2β∗c2∗c1p3∗s1∗χsxDN - 7/16∗δ^2∗c2β∗c2∗c1p3∗s1∗χsxDN +35/6∗c2β∗c2∗c1p3∗s1∗χsxDN +79/48∗c2β∗c2∗c1p3∗s1∗χsxDN - 237/48∗δ^2∗c2β∗c1∗s1p3∗χsxDN - 13/6∗c2β∗c1∗s1p3∗χsxDN DN-1/16∗c2β∗c1∗s1p3∗χsxDN +3/16∗δ^2∗c2∗c1p3∗s1∗χsxDN -5/2∗c2β∗c1∗s1p3∗χsxDN +1/6∗s2β∗c2∗c1p3∗s1∗χszDN - 1/2∗δ^2∗s2β∗c2∗c1p3∗s1∗χszDN +20/3∗s2β∗c2∗c1p3∗s1∗χszDN - 17/16∗c1p3∗s1∗χsxDN+51/16∗δ^2∗c1p3∗s1∗χsxDN+3/2∗c1p3∗s1∗χsxDN- 7∗s2β∗c1p3∗s1∗χszDN +21∗δ^2∗s2β∗c1∗s1p3∗χszDN - 2∗s2β∗c1∗s1p3∗χszDN
